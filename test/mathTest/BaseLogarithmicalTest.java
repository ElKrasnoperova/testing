...
public class BaseLogarithmicalTest {
    ...
    public void ln_forDifferentBases() {
        ...
        for (int i = 0; i < toCalculate.size(); ++i) {
            ...
            assertEquals(requiredList.get(i), ln, 0.001);
        }
    }
